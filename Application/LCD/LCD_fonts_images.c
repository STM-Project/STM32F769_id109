...
//	#define _AAAAA(nr)		if(-1<fontID##nr && IS_RANGE(directionDescr##nr,Above_center,Above_right)){ Ypos += LCD_GetFontHeight(fontID##nr)+interspace##nr; goto _End_Ypos_Correct; }
//	#define _BBBBB(nr)		if(-1<fontID##nr && IS_RANGE(directionDescr##nr,Left_down,Left_up)){	Xpos+=(LCD_GetWholeStrPxlWidth(fontID##nr,txt##nr,space##nr,constWidth##nr)+interspace##nr);	goto _End_Xpos_Correct; }
//
//	_AAAAA(1)
//	_AAAAA(2)
//	_AAAAA(3)

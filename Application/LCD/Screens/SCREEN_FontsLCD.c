...
//																	"+","=",".","0" };
	...
	switch((int)type)
	{
		...
		case KEYBOARD_LenOffsWin:
			//_ServiceLenOffsWin__(type-1, selBlockPress, ARG_KEYBOARD_PARAM, KEY_All_release, KEY_LenWin_plus,Touch_SpacesInfoUp, KEY_Timer, SL(LANG_WinInfo), SL(LANG_WinInfo2), v.FONT_COLOR_Descr);
			_ServiceLenOffsWin();
			break;
